...
var getValue = function getValue(value) {
  return shared.isFluidValue(value) ? value.get() : value;
};

var SpringTransform =
/*#__PURE__*/
function (_AnimationValue) {
  _inheritsLoose(SpringTransform, _AnimationValue);
  ...
  function SpringTransform(inputs, transforms) {
    ...
    _this.node = new animated$1.AnimatedValue(_this._compute());
    return _this;
  } // Required by `AnimationValue` but never used.


  var _proto = SpringTransform.prototype;
  ...
  _proto._compute = function _compute() {
    ...
    shared.each(this.inputs, function (input, i) {
      ...
      var _this2$transforms$i = _this2.transforms[i](shared.is.arr(arg1) ? arg1 : input.map(getValue)),
  ...
  _proto._attach = function _attach() {
    ...
    shared.each(this.inputs, function (input) {
      return shared.each(input, function (value) {
        return shared.isFluidValue(value) && value.addChild(_this3);
      });
    });
  }
  /** @internal */
  ...
  _proto._detach = function _detach() {
    ...
    shared.each(this.inputs, function (input) {
      return shared.each(input, function (value) {
        return shared.isFluidValue(value) && value.removeChild(_this4);
      });
    });
  }
  /** @internal */
